...
$Value = '# Dev Usage:  .\create-sp.ps1 -ServerName ''SERVER.NAME'' -DBName ''mf_config'''
Add-Content -Path $PS1File -Value $Value

$Value = '# Test Usage: .\create-sp.ps1 -ServerName ''SERVER.NAME'' -DBName ''mf_config'''
Add-Content -Path $PS1File -Value $Value

$Value = '# Prod Usage: .\create-sp.ps1 -ServerName ''SERVER.NAME'' -DBName ''mf_config'''
Add-Content -Path $PS1File -Value $Value
